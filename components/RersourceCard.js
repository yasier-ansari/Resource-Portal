        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <button onClick={likeHandler} disabled={disableButton} class="flex absolute top-0 right-2 md:right-3 rounded-lg z-10  bg-white/90 p-2 md:p-3 ">
                        {
                            disableButton ? (
                                ...
                                <LuHeart className={` h-5  stroke-purple-600 w-5 ${likedResource ? ' fill-purple-400  stroke-purple-500 ' : '  '} ${disableButton && ' cursor-not-allowed '} `} />
                            )
                        }
                ...
                <div className="h-[40%] flex justify-start text-start flex-col space-y-2 xs:space-y-3 md:space-y-4 px-3 md:px-4 lg:px-5">
                    <div className="flex justify-between font-bold items-center text-lg md:text-xl">
                        ...
                        <p className="px-2 border-orange-400 border bg-orange-100/70 w-max rounded-lg h-max text-xs font-medium text-black/70">
                            {obj.mainTag}
                        </p>
                    </div>
